...
# Builds the Fraction class and associated FractionTest
Fraction.o : Fraction.cpp Fraction.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c Fraction.cpp

FractionTest.o : FractionTest.cpp Fraction.h $(GTEST_HEADERS)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c FractionTest.cpp

FractionTest : Fraction.o FractionTest.o gtest_main.a
